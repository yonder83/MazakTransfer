...
namespace MazakTransfer
{
    ...
    {
        private readonly static Geometry AscGeometry = Geometry.Parse("M 0,0 L 10,0 L 5,5 Z");

        private readonly static Geometry DescGeometry = Geometry.Parse("M 0,5 L 10,5 L 5,0 Z");
